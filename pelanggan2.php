...
<div class="container">
    ...
    <a href="download-excel-pelanggan.php" class="btn btn-success mb-1 "><i class="fas fa-file-pdf"></i> Download
        Excel</a>
    <a href="download-pdf-pelanggan.php" class="btn btn-danger mb-1 "><i class="fas fa-file-pdf"></i> Download PDF</a>
