...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="" method="post">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 mx-auto mb-3">
                        <img src="assets/img/bootstrap-logo.svg" class="img-fluid d-block mx-auto" alt="Centered Image"
                            width="72" height="57">
                    </div>
                </div>
            </div>
            ...
            <p class="mt-5 mb-3 text-body-secondary text-center"> Copyright&copy; Fairuz <?= date ('Y') ?></p>
        </form>
    </main>
